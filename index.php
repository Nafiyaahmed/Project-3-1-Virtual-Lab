    ...
    <section id="main" style="margin-top:100px;">
      ...
      <div class="container">
              ...
              <form action="table.php" method="POST">
                  <label>Employee Entry</label><br><br>
                    <input type="text" name="dn" class="form-control" placeholder="Employee Name" value=""><br>
										<select class="form-control" name="dept">
											<option value="Engineering">Engineering</option>
											<option value="Foreman">Foreman</option>
											<option value="Labor">Labor</option>
										</select><br><br>
                    <input type="text" name="pl" class="form-control" placeholder="Type Of Work" value=""><br>
										<input type="text" name="pt" class="form-control" placeholder="Hourly Rate" value=""><br>
